        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col items-center justify-center px-6 pt-6 pb-3 text-center">
              <span className="inline-block mb-2 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-white/60 text-todopolis-lavender-deep shadow-sm">
                ✨ Recién llegados
              </span>
            ...
            {gridProducts.length > 0 && (
              <>
                ...
                <div
                  className="md:hidden flex overflow-x-auto gap-1.5 px-4 pb-4"
