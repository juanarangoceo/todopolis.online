        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="flex items-center gap-3 w-28">
              <Link
                href="/favoritos"
                className="group relative p-3 rounded-2xl bg-gradient-to-br from-[#FFD5E5]/50 to-[#EDD2F3]/50 hover:from-[#FFD5E5]/80 hover:to-[#EDD2F3]/80 transition-all duration-300 shadow-sm hover:shadow-md hover:shadow-[#FFD5E5]/30"
